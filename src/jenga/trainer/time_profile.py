        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    print(f"forward time: {forward_time}, backward time: {backward_time}, optimizer step time: {optimizer_step_time}, total time: {forward_time + backward_time + optimizer_step_time}")
                    if step == 3:
                        exit(0)
