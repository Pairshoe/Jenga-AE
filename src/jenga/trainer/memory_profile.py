...
class Trainer:
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    print(f"before step allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
                    torch.cuda.reset_peak_memory_stats()
                    self.optimizer.step()
                    print(f"after step allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
                    if step == 3:
                        exit(0)
                    torch.cuda.reset_peak_memory_stats()                    
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        if self.use_apex:
            ...
            print(f"before backward allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
            torch.cuda.reset_peak_memory_stats()
            self.accelerator.backward(loss, **kwargs)
            print(f"after backward allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
            torch.cuda.reset_peak_memory_stats()
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if self.label_smoother is not None and "labels" in inputs:
            ...
            labels = None
        print(f"before forward allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
        torch.cuda.reset_peak_memory_stats()
        
        outputs = model(**inputs)

        print(f"after forward allocaiton: {torch.cuda.memory_allocated(0)/1024/1024}, peak memory: {torch.cuda.max_memory_allocated(0)/1024/1024}, reserve: {torch.cuda.memory_reserved(0)/1024/1024}")
        torch.cuda.reset_peak_memory_stats()
